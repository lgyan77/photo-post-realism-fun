...
function updateLightboxContent(currentIndex) {
  ...
  if (imageContainer && currentImg) {
    ...
    newImg.style.cssText = 'max-width: calc(100vw - 46mm); max-height: calc(100vh - 66mm); width: auto; height: auto; opacity: 0; position: absolute;';
...
async function renderHome() {
  ...
  footer.className = 'py-16 md:py-24 px-8 md:px-16 lg:px-24 xl:px-32';
  footer.innerHTML = `
    <div class="h-px bg-gray-100 w-full mb-12"></div>
    <p class="text-gray-300 text-xs tracking-widest font-light">
      © ${new Date().getFullYear()} PHOTO POST-REALISM IS FUN
    </p>
  `;
